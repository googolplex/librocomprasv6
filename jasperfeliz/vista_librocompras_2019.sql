-- View: public.vista_librocompras

-- DROP VIEW public.vista_librocompras;
...
CREATE OR REPLACE VIEW public.vista_librocompras AS 
 SELECT narices.q22,
    ...
    narices.lc_numerotimbrado,    
    narices.tiva,
    narices.tipomov,
    narices.datecreated,
    narices.lastupdated,
    narices.usuario,
    narices.modificadopor,
    w.yyyymm,
    w.cte_codigo
   FROM ( SELECT 1 AS q22,
            ...
            to_char(k.lv_fecha, 'YYYY/MM/DD'::text) AS lc_fecha,
            ...
            k.lv_timbrado AS lc_numerotimbrado,
        ...
        UNION ALL
         SELECT 1 AS q22,
            ...
            to_char(k.fecha, 'YYYY/MM/DD'::text) AS lc_fecha,
            ...
            to_char(k.timbradonumero, '9999999999999'::text) AS lc_numerotimbrado,
            1 AS tiva,
        ...
        UNION ALL
         SELECT 1 AS q22,
            ...
            k.cre_timbrado AS lc_numerotimbrado,
