...
@Tab(properties="lvPeriodo,lvFecha,contribuyente.cteNombre,cliente.cliNombre,lvNumeroFactura,numeroTimbrado,lvMontoTotal+,lvMontoIva10+,lvMontoIva5+,lvExento+,tipomov.descripcion,estado.descripcion",defaultOrder="${lvPeriodo} desc,${lvFecha} asc")
@View(members="lvPeriodo,lvFecha,lvNumeroFactura,numeroTimbrado;cliente,lvClienteRuc;contribuyente;"+"Contabilidad [tipoiva,tipomov;formapago,estado;ctaVendedora,ctaCobradora];"+";lvExento,lvMontoBase10,lvMontoBase5;"+"Totales [totalGravada10,lvMontoIva10;totalGravadas5,lvMontoIva5,lvMontoTotal]")
public class LibroVentas extends SuperClaseFeliz  {
	...
	@Pattern(regexp="^[0-9]+$",message="No es un numero TIMBRADO")
	@Column(length=20,nullable=true,name="LV_TIMBRADO")	
